...
data class PiHoleTopClientsCombinedResponseDataV6(
    val all: List<PiHoleTopClientDataV6>,
    val blocked: List<PiHoleTopClientDataV6>,
) {
    ...
    private fun calculateWithPercentages(data: List<PiHoleTopClientDataV6>): List<TopClientData> {
