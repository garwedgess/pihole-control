package eu.wedgess.piholecontrol.ui.filters
...
interface FiltersContract {
    ...
    sealed interface Event {
        ...
        data class OnFilterRuleItemClick(val item: PiHoleFilterRules.PiHoleFilterRule) : Event
        data class OnFilterTabChanged(val type: FilterRuleType) : Event
