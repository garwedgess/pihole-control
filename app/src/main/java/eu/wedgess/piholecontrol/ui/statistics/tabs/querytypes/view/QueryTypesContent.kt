package eu.wedgess.piholecontrol.ui.statistics.tabs.querytypes.view
...
import eu.wedgess.piholecontrol.ui.statistics.view.donutchart.DonutChart
...
fun QueryTypesContent(queryTypes: QueryTypes) {
    ...
    val pieChartData = remember(queryTypes) {
        DonutChartDataCollection(queryTypes.asList().map {
            DonutChartData(
                title = it.first,
                amount = it.second,
