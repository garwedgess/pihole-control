package eu.wedgess.piholecontrol.ui.statistics.tabs.querytypes.viewmodel
...
import eu.wedgess.piholecontrol.ui.statistics.tabs.querytypes.controller.QueryTypesController
...
class QueryTypesViewModel @Inject constructor(
    controller: QueryTypesController
) : ViewModel() {
