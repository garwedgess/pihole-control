...
class FilterRulesRepositoryImplTest {
    ...
    @Test
    fun `fetchFilterRules with connection - should invoke API and return success`() =
        runTest {
    ...
    @Test
    fun `fetchFilterRules with connection - should invoke API and return failure`() =
        runTest {
            val activeConnection = mockk<ConnectionEntity>(relaxed = true)
            val ruleType = mockk<FilterRuleTypeEntity>(relaxed = true)
    ...
    @Test
    fun `addFilterRule with connection - should invoke API and return success`() = runTest {
        val activeConnection = mockk<ConnectionEntity>(relaxed = true)
        val domain = "testRule"
        val ruleType = mockk<FilterRuleTypeEntity>(relaxed = true)
        coEvery {
    ...
    @Test
    fun `addFilterRule with connection - should invoke API and return failure`() = runTest {
        val activeConnection = mockk<ConnectionEntity>(relaxed = true)
        val domain = "testRule"
        val ruleType = mockk<FilterRuleTypeEntity>(relaxed = true)
        val exception = RuntimeException("API error")
    ...
    @Test
    fun `removeFilterRule with connection - should invoke API and return success`() =
        runTest {
            val activeConnection = mockk<ConnectionEntity>(relaxed = true)
            val rule = "testRule"
            val ruleType = mockk<FilterRuleTypeEntity>(relaxed = true)
    ...
    @Test
    fun `removeFilterRule with connection - should invoke API and return failure`() =
        runTest {
            val activeConnection = mockk<ConnectionEntity>(relaxed = true)
            val rule = "testRule"
            val ruleType = mockk<FilterRuleTypeEntity>(relaxed = true)
